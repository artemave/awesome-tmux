...
- [tmux_capture_last_command_output](https://github.com/artemave/tmux_capture_last_command_output) Capture the output of the last terminal command and open it an editor in a separate tmux window.
